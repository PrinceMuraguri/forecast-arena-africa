...
function EarnExplainer() {
  return (
    <div className="rounded-2xl border border-white/10 bg-card p-6">
      <h2 className="font-display text-lg font-semibold">How you get paid</h2>
      <p className="mt-2 text-sm text-muted-foreground">
        Your balance comes from completed polls and correct predictions. Withdraw to
        M-Pesa anytime — no deposits required.
      </p>
      <ul className="mt-4 space-y-2 text-sm">
        <li className="flex gap-2"><span className="text-forecast-gold">•</span> Finish a poll → completion reward credits instantly.</li>
        <li className="flex gap-2"><span className="text-forecast-gold">•</span> Nail a prediction → your share of the prize pool lands when it resolves.</li>
        <li className="flex gap-2"><span className="text-forecast-gold">•</span> Verify your M-Pesa number once, then cash out on demand.</li>
      </ul>
    </div>
  );
}
